...
![1](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755359.png)
...
## [平衡二叉树](https://so.csdn.net/so/search?q=平衡二叉树&spm=1001.2101.3001.7020)

上面我们讲解了利用二叉查找树可以快速的找到数据。但是，如果上面的二叉查找树是这样的构造：

![2](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755452.png)
...
![3](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755015.png)
...
![4](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755030.png)

为了解决平衡二叉树的这个弊端，我们应该寻找一种单个节点可以存储多个键值和数据的平衡树。也就是我们接下来要说的 B 树。

B 树（Balance Tree）即为平衡树的意思，下图即是一棵 B 树：

![5](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755429.png)
...
![6](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755275.png)
...
![7](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755703.png)
...
![8](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755531.png)

### **利用非聚集索引查找数据**

![9](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755740.png)

读者看到这张图的时候可能会蒙，这是啥东西啊？怎么都是数字。如果有这种感觉，请仔细看下图中红字的解释。

什么？还看不懂？那我再来解释下吧。首先，这个非聚集索引表示的是用户幸运数字的索引（为什么是幸运数字？一时兴起想起来的:-)），此时表结构是这样的。

![img](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755729.png)[![91](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755546.png)](http://www.liuzk.com/wp-content/uploads/2019/11/91.jpg)
...
![92](https://qfedu-1254123199.cos.ap-nanjing.myqcloud.com/img/202303071755253.png)
