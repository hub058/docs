...
MySQL - 5.7.38-log : Database - companydb
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`companydb` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
insert  into `t_countries`(`COUNTRY_ID`,`COUNTRY_NAME`) values 
('AR','Argentina'),
('AU','Australia'),
('BE','Belgium'),
('BR','Brazil'),
...
insert  into `t_departments`(`DEPARTMENT_ID`,`DEPARTMENT_NAME`,`MANAGER_ID`,`LOCATION_ID`) values 
...
insert  into `t_employees`(`EMPLOYEE_ID`,`FIRST_NAME`,`LAST_NAME`,`EMAIL`,`PHONE_NUMBER`,`HIRE_DATE`,`JOB_ID`,`SALARY`,`COMMISSION_PCT`,`MANAGER_ID`,`DEPARTMENT_ID`) values 
...
/*Data for the table `t_jobs` */

insert  into `t_jobs`(`JOB_ID`,`JOB_TITLE`,`MIN_SALARY`,`MAX_SALARY`) values 
...
/*Data for the table `t_locations` */

insert  into `t_locations`(`LOCATION_ID`,`STREET_ADDRESS`,`POSTAL_CODE`,`CITY`,`STATE_PROVINCE`,`COUNTRY_ID`) values 
